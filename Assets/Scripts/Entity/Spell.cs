...
public class Spell:Item
{
    ...
    public Spell(Spell spell)
    {
        ...
        directDamage = spell.directDamage;
        continuousDamage = spell.continuousDamage;
        cooldown = spell.cooldown;
        nextLevel = spell.nextLevel;
        preLevel = spell.preLevel;
        target_buff = spell.target_buff;
        self_buff = spell.self_buff;
        target_type = spell.target_type;
        spellImage = spell.spellImage;
        releaseType = spell.releaseType;
